...
lv_obj_t * lv_example_bar_bind_value_create(void)
{
    ...
    lv_subject_increment_dsc_t * subject_increment_event_0 = lv_obj_add_subject_increment_event(lv_button_0, &subject_value, LV_EVENT_CLICKED, -5);
    ...
    lv_subject_increment_dsc_t * subject_increment_event_1 = lv_obj_add_subject_increment_event(lv_button_0, &subject_value, LV_EVENT_LONG_PRESSED_REPEAT, -5);
    ...
    lv_subject_increment_dsc_t * subject_increment_event_2 = lv_obj_add_subject_increment_event(lv_button_1, &subject_value, LV_EVENT_CLICKED, 5);
    ...
    lv_subject_increment_dsc_t * subject_increment_event_3 = lv_obj_add_subject_increment_event(lv_button_1, &subject_value, LV_EVENT_LONG_PRESSED_REPEAT, 5);
