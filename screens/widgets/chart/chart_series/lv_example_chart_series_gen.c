...
lv_obj_t * lv_example_chart_series_create(void)
{
    ...
    lv_chart_series_t * lv_chart_series_0 = lv_chart_add_series(lv_chart_0, lv_color_hex(0xef4444), LV_CHART_AXIS_PRIMARY_Y);
    ...
    lv_chart_series_t * lv_chart_series_1 = lv_chart_add_series(lv_chart_0, lv_color_hex(0x6366f1), LV_CHART_AXIS_SECONDARY_Y);
